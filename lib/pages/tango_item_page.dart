...
class TangoItemPage extends StatefulWidget {
  ...
  @override
  _TangoItemPageState createState() => _TangoItemPageState();
}

class _TangoItemPageState extends State<TangoItemPage> {
  ...
  Widget build(BuildContext context) {
    String itemUrl = contentConverter.contentUrlGenerator(widget.searchResultList[widget.index]);
    // print(itemUrl);
    return Scaffold(
      appBar: AppBar(
        scrolledUnderElevation: 0.0,
        title: Text(widget.searchResultList[widget.index]['heading'].toString()),
        leading: IconButton(
          ...
          Tooltip(
            ...
            child: Container(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  // 收藏
                  widget.searchResultList[widget.index]['url'] = itemUrl;
                  Map<String, dynamic> data = widget.searchResultList[widget.index];
      ...
      body: ItemDetailPage(wordData: widget.searchResultList[widget.index]),
    );
  }
}
